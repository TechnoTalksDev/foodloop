<script>
  ...
  <svelte:head>
    ...
    <meta name="description" content="Complete your FoodLoop order and rescue delicious food from waste." />
  </svelte:head>
  ...
  <div class="bg-white py-12 md:py-16">
    <div class="container mx-auto px-4">
      ...
      <div class="mx-auto max-w-3xl">
        ...
        <!-- Payment Options -->
        <Card.Root class="overflow-hidden border-0 shadow-lg rounded-xl">
          ...
          <Card.Content class="p-6">
            <div class="space-y-4">
              {#each paymentGateways as gateway}
                <a 
                  ...
                  class="block"
                >
                  <div class="flex items-center justify-between rounded-lg border border-gray-200 p-4 transition-colors hover:border-green-300 hover:bg-green-50">
            ...
            <div class="mt-6">
              <a href="/portal/cart" class="inline-flex items-center text-green-600 hover:text-green-700">
