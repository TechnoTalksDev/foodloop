  ...
  <header class="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
    <div class="container flex h-16 items-center justify-between">
      ...
      <a href="/" class="flex items-center gap-2 font-bold text-xl">
        ...
        <span class="rounded-full bg-green-100 px-2 py-1 text-xs text-green-700 ml-1">
          <Leaf class="h-4 w-4 inline mr-1" />
          Save Food
        </span>
      </a>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8">
          <div class="space-y-2">
            ...
            <ul class="space-y-1">
              ...
              <li><a href="/how-it-works" class="text-sm text-muted-foreground hover:text-primary">How It Works</a></li>
          ...
          <div class="space-y-2">
            ...
            <ul class="space-y-1">
              <li><a href="/for-businesses" class="text-sm text-muted-foreground hover:text-primary">Businesses</a></li>
              <li><a href="/for-consumers" class="text-sm text-muted-foreground hover:text-primary">Consumers</a></li>
          ...
          <div class="space-y-2">
            ...
            <ul class="space-y-1">
              ...
              <li><a href="/terms" class="text-sm text-muted-foreground hover:text-primary">Terms & Privacy</a></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="border-t pt-4 flex flex-col md:flex-row justify-between gap-4">
        <p class="text-xs text-muted-foreground">© {new Date().getFullYear()} FoodLoop. All rights reserved.</p>
