...
export const useCommunityNotifications = () => {
  ...
  const notifyPostReply = useCallback((data: {
    postId: number;
    postTitle: string;
    replyContent: string;
    authorName: string;
  ...
  const notifyPostUpvote = useCallback((data: {
    postId: number;
    postTitle: string;
    voterName: string;
    totalUpvotes: number;
  ...
  const notifyGroupJoin = useCallback((data: {
    groupId: number;
    groupName: string;
    memberName: string;
    totalMembers: number;
  ...
  const notifyGroupPost = useCallback((data: {
    postId: number;
    postTitle: string;
    groupName: string;
    authorName: string;
  ...
  const notifyTrendingPost = useCallback((data: {
    postId: number;
    postTitle: string;
    authorName: string;
    upvotes: number;
  ...
  const notifyAchievement = useCallback((data: {
  ...
  const notifyCommunityMilestone = useCallback((data: {
    milestone: string;
    description: string;
  }) => {
    addNotification({
