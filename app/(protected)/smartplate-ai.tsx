...
const AI_MODES = [
	{
		...
		color: "#10b981",
		placeholder:
			"What ingredients do you have? I'll suggest recipes and find items on FoodLoop...",
		systemPrompt:
	...
	},
	{
		...
		color: "#059669",
		placeholder:
			"Take a photo of your plant for health diagnosis and care recommendations...",
		systemPrompt:
			"You are SmartDoctor AI, a plant health and gardening expert. Analyze plant photos to diagnose diseases, pests, nutrient deficiencies, and health issues. Provide detailed care recommendations, organic treatment options, and preventive measures. Focus on sustainable and eco-friendly gardening practices.",
	},
	{
		id: "harvesthelper",
		name: "HarvestHelper",
		...
		color: "#dc2626",
		placeholder:
			"Ask about harvest timing, storage methods, or crop planning...",
		systemPrompt:
			"You are HarvestHelper AI, an agricultural specialist focused on harvest optimization, crop storage, and farming efficiency. Help users determine optimal harvest times, proper storage techniques, and crop planning strategies. Emphasize reducing post-harvest losses and maximizing yield quality.",
	},
	{
		id: "soilsage",
		name: "SoilSage",
		...
		color: "#92400e",
		placeholder:
			"Upload soil photos or ask about soil health, composting, and fertility...",
		systemPrompt:
			"You are SoilSage AI, a soil health and fertility expert. Analyze soil conditions, provide composting advice, recommend organic amendments, and help users improve their soil health naturally. Focus on sustainable farming practices and building healthy soil ecosystems.",
	},
	{
		id: "weatherwise",
		name: "WeatherWise",
		...
		color: "#1d4ed8",
		placeholder:
			"Ask about weather patterns, seasonal planning, or climate adaptation...",
		systemPrompt:
	...
	},
	{
		...
		color: "#059669",
		placeholder:
			"Ask how to reduce waste, preserve food, or repurpose ingredients...",
		systemPrompt:
			"You are WasteWarrior AI, a food waste reduction and sustainability expert. Help users minimize food waste through proper storage, preservation techniques, creative repurposing, and efficient meal planning. Connect users with FoodLoop marketplace opportunities to rescue surplus food.",
	},
];
						...
						>
									...
									{message.images.map((imageUri: string, imgIndex: number) => (
										<Image
											...
											style={{
												...
												borderRadius: 8,
												marginBottom:
													imgIndex < message.images.length - 1 ? 8 : 0,
											}}
											resizeMode="cover"
										/>
									))}
							...
							<Text
								...
								style={{
									color:
										colorScheme === "dark"
											? colors.dark.primaryForeground + "80"
											: colors.light.primaryForeground + "80",
								}}
							>
								{message.timestamp
							...
							<View className="flex-1">
								...
								>
									...
									{message.productSuggestions &&
										renderProductSuggestions(message.productSuggestions)}
								...
								style={{
									backgroundColor:
										item.id === currentMode.id
											...
											: secondaryBg + "30",
									borderColor:
										item.id === currentMode.id ? item.color : borderColor,
								}}
							>
								<View className="flex-row items-center">
									...
									<View className="flex-1">
										<Text
											...
											style={{
												color:
													item.id === currentMode.id ? item.color : textColor,
											}}
										>
											{item.name}
										</Text>
				...
				>
					{loadingWeather ? (
						<View className="flex-row items-center justify-center py-2">
							...
							<Text className="ml-2" style={{ color: mutedTextColor }}>
								...
								<View className="flex-row items-center">
									...
									<View>
										...
										<Text className="text-xs" style={{ color: mutedTextColor }}>
											...
											{weatherData.temperatureUnit === "fahrenheit" ? "F" : "C"}
										</Text>
									</View>
								</View>
							...
							>
								{weatherData.forecast.slice(0, 4).map((day, index) => (
									<View
										...
										style={{ backgroundColor: bgColor, minWidth: 60 }}
									>
										<Text
								...
								<View className="flex-row items-start">
									...
									<View className="flex-1">
										...
										>
											...
											>
												Hello! I'm your {currentMode.name} assistant.{" "}
												{currentMode.description}. How can I help you today?
											</Text>
											<Text
												className="text-xs mt-3"
												style={{ color: mutedTextColor }}
